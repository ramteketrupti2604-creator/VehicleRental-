...
export default function Register() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-[#0a1931] flex items-center justify-center p-3 md:p-4">
      <div className="w-full max-w-[1050px] h-[88vh] md:h-[84vh] bg-white rounded-[24px] shadow-2xl overflow-hidden flex flex-col md:flex-row">
        <div className="relative w-full md:w-[50%] h-[200px] md:h-full shrink-0 overflow-hidden bg-[#0a1931]">
          ...
          <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-end text-white">
            <h1 className="text-[32px] md:text-[46px] font-black leading-[0.9] tracking-tighter">Join &<br/>Start Your<br/><span className="text-sky-300">Journey.</span></h1>
            <p className="text-blue-100/70 text-[12px] mt-3 max-w-[260px] leading-relaxed">Rent premium cars in 2 minutes. Trusted by 10,000+ customers.</p>
        ...
        <div className="w-full md:w-[50%] bg-white flex items-center justify-center p-5 md:p-6 overflow-hidden">
          <div className="w-full max-w-[320px]">
            <div className="w-10 h-10 bg-[#0a1931] rounded-xl flex items-center justify-center"><span className="text-white">🚗</span></div>
            <h2 className="text-[20px] font-black text-slate-900 mt-3 tracking-tight">Create Account</h2>
